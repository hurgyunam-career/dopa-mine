...
| 인증 | Auth Provider / `로그인 제공자` | 소셜 로그인 제공자 | OAuth 기반 외부 인증 서비스(예: Google, Apple). 본 프로젝트 1차 릴리즈는 Google 전용. |
...
| 날짜 | 변경 요약 | 작성자 |
| --- | --- | --- |
| 2026-02-27 | `Auth Provider`/로그인 제공자 용어 추가, 1차 릴리즈 Google 전용 명시 | @cursor-agent |
